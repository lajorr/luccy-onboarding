...
/// @nodoc
abstract class _$$GetUsersDataEventImplCopyWith<$Res> {
  factory _$$GetUsersDataEventImplCopyWith(_$GetUsersDataEventImpl value,
          $Res Function(_$GetUsersDataEventImpl) then) =
      __$$GetUsersDataEventImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$GetUsersDataEventImplCopyWithImpl<$Res>
    extends _$UserEventCopyWithImpl<$Res, _$GetUsersDataEventImpl>
    implements _$$GetUsersDataEventImplCopyWith<$Res> {
  __$$GetUsersDataEventImplCopyWithImpl(_$GetUsersDataEventImpl _value,
      $Res Function(_$GetUsersDataEventImpl) _then)
      : super(_value, _then);
...
class _$GetUsersDataEventImpl implements GetUsersDataEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$GetUsersDataEventImpl);
  }
...
abstract class Success implements UserState {
  const factory Success({required final List<User> users}) = _$SuccessImpl;
...
abstract class Failed implements UserState {
  const factory Failed({required final String message}) = _$FailedImpl;
